...
def upgrade() -> None:
    ...
    op.execute("CREATE SCHEMA IF NOT EXISTS ekart_prod")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_stores_brand ON ekart_prod.stores(brand_id)")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_terminals_store ON ekart_prod.terminals(store_id)")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_devices_status ON ekart_prod.devices(status)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_devices_serial ON ekart_prod.devices(device_serial)")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_orders_store ON ekart_prod.orders(store_id, started_at DESC)")
    op.execute(
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_orders_status ON ekart_prod.orders(status)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_orders_number ON ekart_prod.orders(order_number)")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_order_items_order ON ekart_prod.order_items(order_id)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_order_items_product ON ekart_prod.order_items(product_id)")
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_wa_order ON ekart_prod.whatsapp_messages(order_id)")
    op.execute(
...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS ekart_prod.whatsapp_messages")
    op.execute("DROP TABLE IF EXISTS ekart_prod.device_heartbeats")
    op.execute("DROP TABLE IF EXISTS ekart_prod.audit_logs")
    op.execute("DROP TABLE IF EXISTS ekart_prod.idempotency_keys")
    op.execute("DROP TABLE IF EXISTS ekart_prod.inventory_transactions")
    op.execute("DROP TABLE IF EXISTS ekart_prod.order_items")
    op.execute("DROP TABLE IF EXISTS ekart_prod.orders")
    op.execute("DROP TABLE IF EXISTS ekart_prod.customers")
    op.execute("DROP TABLE IF EXISTS ekart_prod.device_terminal_assignments")
    op.execute("DROP TABLE IF EXISTS ekart_prod.devices")
    op.execute("DROP TABLE IF EXISTS ekart_prod.terminals")
    op.execute("DROP TABLE IF EXISTS ekart_prod.stores")
    op.execute("DROP TABLE IF EXISTS ekart_prod.brands")
